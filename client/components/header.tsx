...
function Header({ size, title, button,subheading }: HeaderProps) {
  return (
    <div className="w-full py-5 flex justify-between items-start lg:px-5 px-2 md:px-3 bg-light-green dark:bg-zinc-800">
      ...
      {button && (<Button className="bg-black hover:border dark:hover:bg-zinc-500 cursor-pointer  text-white dark:bg-zinc-700" >{button}</Button>)}
    </div>
  );
}
