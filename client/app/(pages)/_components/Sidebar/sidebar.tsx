...
function Sidebar() {
  ...
  return (
    <aside
      ...
      flex flex-col gap-4
      h-screen md:w-[30vw] lg:w-[23vw] w-3/5
    ...
    >
      <div className="w-full  py-3 flex gap-2 border-b border-gray-300 dark:border-gray-700 justify-between items-center">
        ...
        >
          <RxCross2 size={24} className="cursor-pointer dark:text-white" />
        </button>
      </div>
      ...
      <div>
        ...
        <div
          ...
          className="text-gray-500 py-5 dark:text-gray-500 text-xs px-4 flex justify-between items-center"
        >
          <p>Projects</p>
          {isProjectsOpen ? (
