...
function Page() {
  ...
  return (
    <div className="flex items-center py-8 h-full pb-10 w-full flex-col p-5 overflow-y-scroll scroll ">
      <p className="text-3xl font-semibold text-start w-full mb-3">Projects Timeline</p>
      ...
      <div className="grid grid-cols-6  auto-rows-min min-w-[800px]  dark:bg-zinc-850  border-y border-gray-500 ">
        ...
        {projects &&
          projects.map((item) => {
            ...
            const totalDuration = new Date(item.endDate).getTime() - new Date(item.startDate).getTime();
           ...
           percent = Math.min(Math.max(percent, 0), 100);
            ...
            return (
              <div className="contents" key={item.id}>
                ...
                <div className="col-span-1 h-14 w-full  center dark:text-gray-200 dark:dark-zinc-700 border-gray-500 border-r">
                  {new Date(item.endDate).toLocaleDateString("en-US", {day:"2-digit", month:"short", year:"numeric"})}
                </div>
